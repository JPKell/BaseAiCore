...
BaseAiCore is part of the Local AI Suite, whose default posture is local-first: it binds to
...
* The component version (`baseaicore --version` for applications, or the installed
